...
export class AccountService {
  ...
  fetch(): Observable<Account> {
    return this.http.get<Account>(SERVER_API_URL + 'services/soptorshioauth/api/account');
  }

  save(account: Account): Observable<Account> {
    return this.http.post<Account>(SERVER_API_URL + 'services/soptorshioauth/api/account', account);
  }
